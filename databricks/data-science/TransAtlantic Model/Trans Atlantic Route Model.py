...
# MAGIC %md
# MAGIC # Models Generation to Predict Status of Transatlantic Route
# MAGIC
# MAGIC In this notebook you can find the training process for the transatlantic route fstatus predictions. 
...
# MAGIC
# MAGIC 4. Filter for locations of interest, In our case as we are focusing on the Transatlantic Route , we would focus on this location: "UKF2", "UKN5", "GM04", "GM03", "SP51", "SP60", "USNY", "USGA", "USFL", "CA10", "CA07"
...
# MAGIC %md
# MAGIC By analyzing this graph we are going to use a lag of 8, as it represent a growing autocorrelation as the lag period advance
...
# MAGIC %md
# MAGIC The P value in our series is  0.0004360012277073865. Is not lower than 0.05. this means that our series in NOT STATIONARY. So we have to make the serie Stationary to have Better Forecasting Results
...
# MAGIC %md
# MAGIC Now, are P value is 1.0612594331321033e-13, Very below to 0.05. So now we can start thinking abour Time Series Forecasting
...
my_callback = MyThresholdCallback(threshold=0.1050) # CREATING CALL BACK
...
TRAIN_RESULTS['Date'] = GKG_DAILY_FINAL_PANDAS_TRAIN['Date'][8:]
#PRUEBA['test'] = y_test
...
TEST_RESULTS['Date'] = GKG_DAILY_FINAL_PANDAS_TEST['Date'][8:]
#PRUEBA['test'] = y_test
...
model.save("TAR_model.keras")

# COMMAND ----------

scaler_filename = "scalerTAR.save"
joblib.dump(scaler, scaler_filename) 

# COMMAND ----------

scaler_filename = "scalerTAR_Obj.save"
...
NEWS_PREDICTION = GKG_DAILY_FINAL_PANDAS_TEST[8:] # GET VALUES THAT WOULD HAVE A PREDICTION (8 DAY LAG)
...
# MAGIC %md
# MAGIC It's pretty good! Now this is the end of the model generating model for the TransAtlantic Route
