...
GKG_DAILY_FINAL_PANDAS = GKG_DAILY_FINAL.toPandas() #CONVERTING DATAFRAME TO PANDAS
...
n_input=7 # INPUTS FOR PREDICTIONS

# COMMAND ----------

# LOAD MODELS AND SCALERS

TPRMODEL = keras.saving.load_model("TransPacificModel/TPR_model.keras")
X_SCALER = joblib.load("TransPacificModel/scalerTPR.save")
Y_SCALER = joblib.load("TransPacificModel/scalerTPR_Obj.save") 

# COMMAND ----------

# DROPPING DATE AS IS NOT AN PREDICTOR
GKG_DAILY_FINAL_PANDAS_PRED = GKG_DAILY_FINAL_PANDAS.drop("Date", axis = 1)

# COMMAND ----------

scaled_data = X_SCALER.transform(GKG_DAILY_FINAL_PANDAS_PRED) #SCALE DATA FOR PREDICTING
...
# TRANSFORM PREDICTIONS INTO REAL VALUES
...
table_name = "gold.g_gdelt_gkg_trans_pacific_route_predictions"
delta_table_path = f"s3://databricks-workspace-stack-e63e7-bucket/unity-catalog/2600119076103476/gold/gdelt/gkg_trans_pacific_route_predictions/"  # O especifica una ruta personalizada si usas S3 o DBFS
