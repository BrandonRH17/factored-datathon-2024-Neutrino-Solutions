...
# MAGIC %md
# MAGIC The P value in our series is 0.3241974942253528. Is not lower than 0.05. this means that our series in NOT STATIONARY. So we have to make the serie Stationary to have Better Forecasting Results
...
# MAGIC %md
# MAGIC Now, are P value is   5.927850762086913e-11, Very below to 0.05. So now we can start thinking abour Time Series Forecasting
...
my_callback = MyThresholdCallback(threshold=0.1240) # CREATING CALL BACK
