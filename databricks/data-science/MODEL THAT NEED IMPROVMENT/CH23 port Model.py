...
# MAGIC %md
# MAGIC # Models Generation to Predict CH23 port status
# MAGIC
# MAGIC In this notebook you can find the training process for the model for CH23 port status predictions. 
...
# MAGIC
# MAGIC 4. Filter for locations of interest, In our case as we are focusing on the port CH23, we would focus on this locations: "CH23"
...
.filter(col("LocationCode").isin("CH23")) # FILTER THE NEWS RELATED TO THE LOCATIONS OF THE PORT (CHECK DEFINITION IN THE CELL ABOVE FOR MORE DETAILS IN THE CODES)
)
