...
# MAGIC %md
# MAGIC # Models Generation to Predict Status of CH30 Port
# MAGIC
...
# MAGIC
# MAGIC 4. Filter for locations of interest, In our case as we are focusing on the transpacific route, we would focus on this locations: "CH23"
...
# MAGIC %md
# MAGIC By analyzing this graph we are going to use a lag of 7, the autocorrelation is bad.
...
# MAGIC %md
# MAGIC The P value in our series is 0. 0.00025088906796925887. Is not lower than 0.05. this means that our series in STATIONARY. We are going to apply differencing to make the results even with other models
...
my_callback = MyThresholdCallback(threshold=0.13) # CREATING CALL BACK
...
# MAGIC %md
# MAGIC It's pretty good! Now this is the end of the model generating model for the Transpacific Route
